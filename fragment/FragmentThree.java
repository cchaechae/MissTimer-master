...
public class FragmentThree extends Fragment implements AdapterCallback {
    ...
    public View onCreateView(LayoutInflater inflater,
        ...
        View rootView = inflater.inflate(R.layout.delete_list, container, false);

        RecyclerView rv = (RecyclerView) rootView.findViewById(R.id.delte_list);
        rv.setHasFixedSize(true);

        adapter = new ProductAdapter(getContext(), FirebaseAuth.getInstance().getCurrentUser().getUid(), FragmentThree.this);
        ...
        postsRef.addChildEventListener(new ChildEventListener() {
            ...
            public void onCancelled(DatabaseError databaseError) {
                ...
                Log.w(TAG, "fragment three:onCancelled", databaseError.toException());
